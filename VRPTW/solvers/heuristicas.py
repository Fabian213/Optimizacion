from VRPTW.estructura import Problem, Route
import itertools
...
class DummyHeuristic:
    ...
    def get_solution(self):
        """Solución muestreada de la lista de clientes, ordenada por fecha de vencimiento."""
...
class IteratedLocalSearch(LocalSearch):
    ...
    def execute(self):
        ...
        print("Solución de búsqueda local:")
        print(self.problem.print_canonical(best))
        print("Distancia Total", self.obj_func(best))
        ...
        while not is_stuck:
            ...
            if self.obj_func(new_solution) < self.obj_func(best):
                ...
                print("Paso ILS (búsqueda local iterativa)")
                print(self.problem.print_canonical(best))
                print("Distancia Total", self.obj_func(best))
        return best
